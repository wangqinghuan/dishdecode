  ...
  return (
    <html lang="en">
      ...
      <body>
        ...
        <footer style={{ textAlign: 'center', padding: '32px', color: '#666', fontSize: '14px', borderTop: '1px solid #eee', marginTop: '40px' }}>
          <div style={{ display: 'flex', justifyContent: 'center', gap: '16px', alignItems: 'center' }}>
            <a href="https://github.com/wangqinghuan" target="_blank" rel="noopener" style={{ color: '#666', textDecoration: 'none', display: 'flex', alignItems: 'center', gap: '6px' }}>
          ...
          <p style={{ marginTop: '12px' }}>© 2024 DishDecode. All rights reserved.</p>
        </footer>
      </body>
    </html>
  );
